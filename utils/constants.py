database_initialize_order = ["database_initializer\ims_initializer.sql"]
...
table_initialize_order = [
    ...
    "table_initializer\invoice_line_items_initializer.sql",
    "table_initializer\processes_initializer.sql",
]