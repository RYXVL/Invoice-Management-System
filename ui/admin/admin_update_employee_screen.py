...
class UpdateEmployee:
    ...
    def __init__(self, root):
        ...
        # Update button
        self.update_button = tk.Button(self.root, text="Update", font=("times new roman", 14), command=self.update_employee)
        self.update_button.pack(pady=10)

    # Function to print entered employee details
